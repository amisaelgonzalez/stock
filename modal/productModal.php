    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="priceMayoreo" class="col-sm-3 control-label">Precio de mayoreo: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="priceMayoreo" placeholder="Precio de mayoreo" name="priceMayoreo" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

	        <div class="form-group">
	        	<label for="priceMenudeo" class="col-sm-3 control-label">Precio de menudeo: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="priceMenudeo" placeholder="Precio de menudeo" name="priceMenudeo" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			        	<label for="editPriceMayoreo" class="col-sm-3 control-label">Precio de mayoreo: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editPriceMayoreo" placeholder="Precio" name="editPriceMayoreo" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->

			        <div class="form-group">
			        	<label for="editPriceMenudeo" class="col-sm-3 control-label">Precio de menudeo: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
